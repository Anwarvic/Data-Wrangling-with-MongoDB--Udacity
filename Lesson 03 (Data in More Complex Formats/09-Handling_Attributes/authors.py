...
def get_authors(root):
    ...
    for author in root.findall('./fm/bibl/aug/au'):
        ...
        # YOUR CODE HERE
        author_firstname = author.find("fnm").text
        author_surname = author.find("snm").text
        author_email = author.find("email").text
        data["fnm"] = author_firstname
        data["snm"] = author_surname
        data["email"] = author_email
        iid_list = author.findall("insr")
        for x in iid_list:
            data["insr"].append(x.get("iid"))
